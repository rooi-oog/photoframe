...
#define CSR_MEMCARD_CLK2XDIV		MMPTR(0x30004000)

#define CSR_MEMCARD_ENABLE			MMPTR(0x30004004)
...
#define CSR_MEMCARD_PENDING			MMPTR(0x30004008)
...
#define CSR_MEMCARD_START			MMPTR(0x3000400c)

#define MEMCARD_START_CMD_RX		(0x1)
#define MEMCARD_START_DAT_RX		(0x2)

#define CSR_MEMCARD_CMD				MMPTR(0x30004010)
#define CSR_MEMCARD_DAT				MMPTR(0x30004014)

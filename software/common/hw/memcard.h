...
#define CSR_MEMCARD_CLK2XDIV		MMPTR(0x30003000)

#define CSR_MEMCARD_ENABLE			MMPTR(0x30003004)
...
#define CSR_MEMCARD_PENDING			MMPTR(0x30003008)
...
#define CSR_MEMCARD_START			MMPTR(0x3000300c)

#define MEMCARD_START_CMD_RX		(0x1)
#define MEMCARD_START_DAT_RX		(0x2)

#define CSR_MEMCARD_CMD				MMPTR(0x30003010)
#define CSR_MEMCARD_DAT				MMPTR(0x30003014)
